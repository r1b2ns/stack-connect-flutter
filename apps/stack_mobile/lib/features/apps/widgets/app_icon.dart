...
///
/// While the URL resolves, fails, or comes back null, a Material rounded
/// placeholder tile (an apps glyph on a subtle surface) is shown — so the widget
/// always occupies the same [size]x[size] footprint regardless of state.
